                    ...
                    cart?.length > 0 && cart.map((product) => (
                        <div key={product.id} className='cartItem'>
                            ...
                            <div className='cartActions'>
                                <button onClick={() => onAddToCart(product.id)} className='cartButttonAdd'><i class='material-symbols-rounded'> add </i></button>
                                <button onClick={() => onDecreaseItem(product.id)} className='cartButttonDecrease'><i class='material-symbols-rounded'> remove </i></button>
                                <button onClick={() => onRemoveItem(product.id)} className='cartButttonRemove'><i class='material-symbols-rounded'> delete </i></button>
                            </div>
                        </div>
                    ))
                }
